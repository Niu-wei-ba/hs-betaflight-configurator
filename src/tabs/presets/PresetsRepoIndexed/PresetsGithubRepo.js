...
import { appConfig, buildRawProxyBaseUrl } from "../../../js/AppConfig";
...
export default class PresetsGithubRepo extends PresetsRepoIndexed {
    constructor(urlRepo, branch, official, name) {
        ...
        const rawUrl = `https://raw.githubusercontent.com${correctUrlRepo.slice(
            "https://github.com".length,
        )}${correctBranch}/`;
        const urlRaw = appConfig.proxyThirdPartyPresets ? buildRawProxyBaseUrl(rawUrl) : rawUrl;
